...
public class GetExecutableNameByIdQueryHandler : IRequestHandler<GetExecutableNameByIdQuery, string?>
{
    ...
    public Task<string?> Handle(GetExecutableNameByIdQuery request, CancellationToken cancellationToken)
    {
